# Comparador de ZIP - Versión 0.4.0
#
# Descripción:
...
#   naranja para diferencias de fecha, blanco para idénticos, gris claro (texto) para marcadores, coral claro para directorios con diferencias.
...
def main():
    root = tk.Tk()
    root.title("Comparador de ZIP con Árboles Sincronizados - v0.4.0")
